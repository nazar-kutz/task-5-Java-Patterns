package behavioral.chain_of_responsibitily;
...
public class ATMApp {
    public static void main(String[] args) {
        ...
        note5000.takeMoney(new Money(190_700));
    }
}
...
class Money{
    ...
    public void setAmt(int amt) {
        if(amt > 0 && amt <= 200_000 && amt % Note.R100 == 0){
            ...
            throw new RuntimeException("Сумма денег должна быть не более 200 000 и кратная 100");
        }
    }
}
